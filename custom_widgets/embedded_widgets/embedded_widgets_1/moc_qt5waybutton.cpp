...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Qt5WayButton_t, stringdata) + ofs \
...
const QMetaObject Qt5WayButton::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Qt5WayButton.data,
      qt_meta_data_Qt5WayButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Qt5WayButton.stringdata))
