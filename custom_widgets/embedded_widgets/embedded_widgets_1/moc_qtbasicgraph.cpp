...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QtBasicGraph_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 28, 5)
    ...
    "QtBasicGraph\0addPoint\0\0data\0clear\0"
};
...
const QMetaObject QtBasicGraph::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QtBasicGraph.data,
      qt_meta_data_QtBasicGraph,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtBasicGraph.stringdata))
