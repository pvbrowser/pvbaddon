...
struct qt_meta_stringdata_QtScrollDial_t {
    QByteArrayData data[4];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QtScrollDial_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtScrollDial_t qt_meta_stringdata_QtScrollDial = {
    {
QT_MOC_LITERAL(0, 0, 12), // "QtScrollDial"
QT_MOC_LITERAL(1, 13, 16), // "updateLabelValue"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 4) // "skin"

    },
    "QtScrollDial\0updateLabelValue\0\0skin"
};
...
void QtScrollDial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QtScrollDial *_t = static_cast<QtScrollDial *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtScrollDial::staticMetaObject = {
    { &QAbstractSlider::staticMetaObject, qt_meta_stringdata_QtScrollDial.data,
      qt_meta_data_QtScrollDial,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtScrollDial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtScrollDial.stringdata0))
