...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QtScrollDial_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 31, 4)
    ...
    "QtScrollDial\0updateLabelValue\0\0skin\0"
};
...
const QMetaObject QtScrollDial::staticMetaObject = {
    { &QAbstractSlider::staticMetaObject, qt_meta_stringdata_QtScrollDial.data,
      qt_meta_data_QtScrollDial,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtScrollDial.stringdata))
