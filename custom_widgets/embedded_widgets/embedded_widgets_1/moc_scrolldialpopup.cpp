...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PopupCloseButton_t, stringdata) + ofs \
...
const QMetaObject PopupCloseButton::staticMetaObject = {
    { &QAbstractButton::staticMetaObject, qt_meta_stringdata_PopupCloseButton.data,
      qt_meta_data_PopupCloseButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PopupCloseButton.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ScrollDialPopup_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject ScrollDialPopup::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ScrollDialPopup.data,
      qt_meta_data_ScrollDialPopup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ScrollDialPopup.stringdata))
