...
static int generated_defineMask(PARAM *p)
{
  ...
  pvToolTip(p,obj1,"/0/1/000");

  pvQPushButton(p,buttonOn,0);
  pvSetGeometry(p,buttonOn,10,40,100,30);
  pvSetText(p,buttonOn,"On");

  pvQPushButton(p,buttonOff,0);
  pvSetGeometry(p,buttonOff,125,40,100,30);
  pvSetText(p,buttonOff,"Off");

  pvQPushButton(p,buttonList,0);
  pvSetGeometry(p,buttonList,240,40,100,30);
