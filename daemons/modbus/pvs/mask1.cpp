...
static int generated_defineMask(PARAM *p)
{
  ...
  pvSetText(p,buttonIncrement1,"Increment1");

  pvQPushButton(p,buttonIncrement2,0);
  pvSetGeometry(p,buttonIncrement2,490,90,100,30);
  pvSetText(p,buttonIncrement2,"Increment2");

  pvQPushButton(p,buttonIncrement3,0);
  pvSetGeometry(p,buttonIncrement3,490,130,100,30);
  pvSetText(p,buttonIncrement3,"Increment3");

  pvQPushButton(p,buttonRegister,0);
  pvSetGeometry(p,buttonRegister,355,130,130,30);
  pvSetText(p,buttonRegister,"Register++");

  pvQLabel(p,ReadErrorCount,0);
  pvSetGeometry(p,ReadErrorCount,630,10,175,30);
  pvSetText(p,ReadErrorCount,"Label");
  pvSetFont(p,ReadErrorCount,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,WriteErrorCount,0);
  pvSetGeometry(p,WriteErrorCount,630,50,170,30);
  pvSetText(p,WriteErrorCount,"Label");
  pvSetFont(p,WriteErrorCount,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,LifeCounter,0);
  pvSetGeometry(p,LifeCounter,630,90,170,30);
  pvSetText(p,LifeCounter,"Label");
  pvSetFont(p,LifeCounter,"Sans Serif",10,0,0,0,0);
