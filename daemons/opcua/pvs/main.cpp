...
#ifdef RLWIN32
rlOpcXmlDa opc("c:\\automation\\mbx\\opcua.mbx", "c:\\automation\\shm\\opcua.shm", 65536);
#else
rlOpcXmlDa opc("/srv/automation/mbx/opcua.mbx", "/srv/automation/shm/opcua.shm", 65536);
#endif
