////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Di. Aug. 26 06:39:07 2014
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvDownloadFile(p,"");
  pvQImage(p,webcam1,0,"",&w,&h,&depth);
  pvSetGeometry(p,webcam1,5,5,480,640);
  pvSetFont(p,webcam1,"Sans Serif",10,0,0,0,0);
