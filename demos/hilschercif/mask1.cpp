////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Mi Feb 14 10:18:44 2007
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,title,0);
  pvSetGeometry(p,title,10,10,435,45);
  pvSetText(p,title,"Hilscher CIF Test using PROFIBUS");
  pvSetFont(p,title,"Sans Serif",16,0,0,0,0);

  pvQLabel(p,obj1,0);
  pvSetGeometry(p,obj1,10,65,50,30);
  pvSetText(p,obj1,"Input");

  pvQSpinBox(p,spinOutput0,0,0,255,1);
  pvSetGeometry(p,spinOutput0,70,100,100,30);

  pvQLabel(p,obj4,0);
  pvSetGeometry(p,obj4,10,100,50,30);
  pvSetText(p,obj4,"Output");

  pvQLabel(p,labelInput0,0);
  pvSetGeometry(p,labelInput0,70,65,100,30);
  pvSetText(p,labelInput0,"Hex");

  pvQLabel(p,labelInput1,0);
  pvSetGeometry(p,labelInput1,180,65,100,30);
  pvSetText(p,labelInput1,"Hex");

  pvQSpinBox(p,spinOutput1,0,0,255,1);
  pvSetGeometry(p,spinOutput1,180,100,100,30);
