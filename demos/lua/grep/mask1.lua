...
function showMask1(p)
  ...
  widgetType[2] = pv.TQLineEdit
  widgetType[3] = pv.TQTextBrowser

  pv.pvStartDefinition(p,ID_END_OF_WIDGETS)

  pv.pvQPushButton(p,buttonGrep,0)
  pv.pvSetGeometry(p,buttonGrep,655,15,110,30)
  pv.pvSetText(p,buttonGrep,"&grep")
  pv.pvSetFont(p,buttonGrep,"Sans Serif",10,0,0,0,0)

  pv.pvQLineEdit(p,lineEditGrep,0)
  pv.pvSetGeometry(p,lineEditGrep,5,15,640,25)
  pv.pvSetText(p,lineEditGrep,"")
  pv.pvSetFont(p,lineEditGrep,"Sans Serif",10,0,0,0,0)

  pv.pvQTextBrowser(p,browserGrep,0)
  pv.pvSetGeometry(p,browserGrep,5,50,760,520)
  pv.pvSetFont(p,browserGrep,"Sans Serif",10,0,0,0,0)

  pv.pvQLayoutHbox(p,ID_MAIN_WIDGET,-1);

  pv.pvQLayoutVbox(p,layout1,-1);

  pv.pvQLayoutHbox(p,layout2,-1);

  pv.pvAddWidgetOrLayout(p,layout2,lineEditGrep,-1,-1)
  pv.pvAddWidgetOrLayout(p,layout2,buttonGrep,-1,-1)
  pv.pvAddWidgetOrLayout(p,layout1,layout2,-1,-1)
  pv.pvAddWidgetOrLayout(p,layout1,browserGrep,-1,-1)
  pv.pvAddWidgetOrLayout(p,ID_MAIN_WIDGET,layout1,-1,-1)
