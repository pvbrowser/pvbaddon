...
function showMask1(p)
  ...
  widgetType[2] = pv.TQDraw

  pv.pvStartDefinition(p,ID_END_OF_WIDGETS)

  pv.pvQPushButton(p,pushButtonQwt,0)
  pv.pvSetGeometry(p,pushButtonQwt,10,10,111,40)
  pv.pvSetText(p,pushButtonQwt,"Goto QWT")
  pv.pvSetFont(p,pushButtonQwt,"Sans Serif",10,0,0,0,0)

  pv.pvQDraw(p,drawWidget,0)
  pv.pvSetGeometry(p,drawWidget,10,60,880,575)
  pv.pvSetFont(p,drawWidget,"Sans Serif",10,0,0,0,0)
