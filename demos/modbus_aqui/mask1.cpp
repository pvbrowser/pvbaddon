////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: So Nov 2 12:04:51 2008
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,COIL_10,0);
  pvSetGeometry(p,COIL_10,15,15,230,30);
  pvSetText(p,COIL_10,"Label");
  pvSetFont(p,COIL_10,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,COIL_18,0);
  pvSetGeometry(p,COIL_18,15,45,215,30);
  pvSetText(p,COIL_18,"Label");
  pvSetFont(p,COIL_18,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,COIL_20,0);
  pvSetGeometry(p,COIL_20,15,75,225,30);
  pvSetText(p,COIL_20,"Label");
  pvSetFont(p,COIL_20,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,COIL_216,0);
  pvSetGeometry(p,COIL_216,15,105,215,30);
  pvSetText(p,COIL_216,"Label");
  pvSetFont(p,COIL_216,"Sans Serif",10,0,0,0,0);

  pvQSpinBox(p,DO,0,0,1,1);
  pvSetGeometry(p,DO,80,140,100,30);
  pvSetFont(p,DO,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,obj2,0);
  pvSetGeometry(p,obj2,15,140,60,25);
  pvSetText(p,obj2,"DO=");
  pvSetFont(p,obj2,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,ADR,0);
  pvSetGeometry(p,ADR,215,140,45,30);
  pvSetText(p,ADR,"ADR=");
  pvSetFont(p,ADR,"Sans Serif",10,0,0,0,0);

  pvQSpinBox(p,SPIN_ADR,0,16,23,1);
  pvSetGeometry(p,SPIN_ADR,260,140,100,30);
  pvSetFont(p,SPIN_ADR,"Sans Serif",10,0,0,0,0);
