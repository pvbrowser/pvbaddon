////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Mi Mrz 28 18:50:07 2007
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvSetGeometry(p,table1,10,55,285,220);

  pvQLabel(p,obj2,0);
  pvSetGeometry(p,obj2,10,10,375,40);
  pvSetText(p,obj2,pvtr("Modbus over serial line"));
  pvSetFont(p,obj2,"Sans Serif",16,0,0,0,0);

  pvQLabel(p,lifeCounter,0);
  pvSetGeometry(p,lifeCounter,315,60,220,30);
  pvSetText(p,lifeCounter,pvtr("Label"));
  pvSetFont(p,lifeCounter,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,readErrorCount,0);
  pvSetGeometry(p,readErrorCount,315,95,210,30);
  pvSetText(p,readErrorCount,pvtr("Label"));
  pvSetFont(p,readErrorCount,"Sans Serif",10,0,0,0,0);

  pvQLabel(p,writeErrorCount,0);
  pvSetGeometry(p,writeErrorCount,315,130,225,30);
  pvSetText(p,writeErrorCount,pvtr("Label"));
