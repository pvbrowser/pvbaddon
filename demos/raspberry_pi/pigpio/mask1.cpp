////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Do. Dez 27 11:02:01 2012
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQTable(p,table,0,2,2);
  pvSetGeometry(p,table,6,6,420,700);
  pvSetFont(p,table,"Sans Serif",9,0,0,0,0);
  pvSetMinSize(p,table,420,420);
  pvSetMaxSize(p,table,420,99999);

  pvQLayoutVbox(p,ID_MAIN_WIDGET,-1);

  pvAddWidgetOrLayout(p,ID_MAIN_WIDGET,table,-1,-1);
