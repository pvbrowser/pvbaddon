////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Mo. Dez 31 09:24:35 2012
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQMultiLineEdit(p,edit,0,1,-1);
  pvSetGeometry(p,edit,5,40,500,380);
  pvSetFont(p,edit,"Sans Serif",10,0,0,0,0);
  pvSetMinSize(p,edit,300,0);
  pvSetMaxSize(p,edit,500,99999);

  pvQDraw(p,svgview,0);
  pvSetGeometry(p,svgview,525,40,500,385);
  pvSetFont(p,svgview,"Sans Serif",10,0,0,0,0);
  pvSetMinSize(p,svgview,800,0);
  pvSetMaxSize(p,svgview,99999,99999);

  pvQPushButton(p,update,0);
  pvSetGeometry(p,update,5,5,100,30);
  pvSetText(p,update,pvtr("Update"));
  pvSetFont(p,update,"Sans Serif",10,0,0,0,0);
  pvSetMaxSize(p,update,100,30);

  pvQLayoutVbox(p,ID_MAIN_WIDGET,-1);

  pvQLayoutHbox(p,layout1,ID_MAIN_WIDGET);

  pvAddWidgetOrLayout(p,layout1,edit,-1,-1);
  pvAddWidgetOrLayout(p,layout1,svgview,-1,-1);
  pvAddWidgetOrLayout(p,ID_MAIN_WIDGET,update,-1,-1);
