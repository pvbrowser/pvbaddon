////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Mo Mrz 12 09:37:45 2007
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,obj1,0);
  pvSetGeometry(p,obj1,252,0,354,66);
  pvSetText(p,obj1,"RealTimePVB");
  pvSetFont(p,obj1,"Arial",35,0,0,0,0);

  pvQDraw(p,svgStartscreen,0);
  pvSetGeometry(p,svgStartscreen,125,70,594,390);

  pvQGroupBox(p,obj4,0,-1,HORIZONTAL,"Navigation");
  pvSetGeometry(p,obj4,0,60,114,399);

  pvQPushButton(p,btExample,obj4);
  pvSetGeometry(p,btExample,10,20,99,30);
  pvSetText(p,btExample,"Example");

  pvQLabel(p,obj5,0);
  pvSetGeometry(p,obj5,0,468,470,20);
  pvSetText(p,obj5,"RealTimePVB V 0.0.1 - © 2007 - Sebastian Lehrig (sebastian@lehrig.de)");
