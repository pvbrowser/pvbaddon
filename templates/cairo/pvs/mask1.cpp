////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Mo. Nov. 6 08:41:58 2017
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,lbHelloWorld,0);
  pvSetGeometry(p,lbHelloWorld,0,0,100,30);
  pvSetText(p,lbHelloWorld,pvtr("Hello World"));
  pvSetFont(p,lbHelloWorld,"Noto Sans",10,0,0,0,0);

  pvQDraw(p,draw1,0);
  pvSetGeometry(p,draw1,1,35,800,640);
  pvSetFont(p,draw1,"Noto Sans",10,0,0,0,0);
