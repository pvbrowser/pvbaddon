////////////////////////////////////////////////////////////////////////////
//
// show_mask2 for ProcessViewServer created: Do. Okt. 26 13:11:23 2017
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQDraw(p,svg1,0);
  pvSetGeometry(p,svg1,1,1,1280,1024);
  pvSetFont(p,svg1,"Noto Sans",10,0,0,0,0);

  pvQPushButton(p,obj1,svg1);
  pvSetGeometry(p,obj1,85,85,100,30);
  pvSetText(p,obj1,pvtr("&PushButton"));
  pvSetFont(p,obj1,"Noto Sans",10,0,0,0,0);

  pvQLabel(p,obj2,svg1);
  pvSetGeometry(p,obj2,135,115,280,30);
  pvSetText(p,obj2,pvtr("set any other widgets over the svg ..."));
  pvSetFont(p,obj2,"Noto Sans",10,0,0,0,0);
