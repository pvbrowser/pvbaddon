////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Sa. Dez. 31 12:35:10 2016
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvSetGeometry(p,obj1,95,70,100,30);
  pvSetText(p,obj1,pvtr("&PushButton"));
  pvSetFont(p,obj1,"Noto Sans",10,0,0,0,0);

  pvQDraw(p,drawWidget1,0);
  pvSetGeometry(p,drawWidget1,10,110,1210,740);
  pvSetFont(p,drawWidget1,"Noto Sans",10,0,0,0,0);
