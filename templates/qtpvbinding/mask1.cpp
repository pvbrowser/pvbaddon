////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Sa. Mrz 5 08:49:22 2011
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvSetGeometry(p,buttonHello,35,30,100,30);
  pvSetText(p,buttonHello,"Hello");
  pvSetFont(p,buttonHello,"Sans Serif",10,0,0,0,0);

  pvQPushButton(p,buttonWorld,0);
  pvSetGeometry(p,buttonWorld,155,30,100,30);
  pvSetText(p,buttonWorld,"World");
  pvSetFont(p,buttonWorld,"Sans Serif",10,0,0,0,0);
