...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,labelState,rightWidget);
  pvSetGeometry(p,labelState,10,210,190,35);
  pvSetText(p,labelState,pvtr("NULL"));
  pvSetFont(p,labelState,"Courier",10,0,0,0,0);
  ...
  pvQPushButton(p,buttonStart,rightWidget);
  pvSetGeometry(p,buttonStart,10,175,100,30);
  pvSetText(p,buttonStart,pvtr("Start"));
  pvSetFont(p,buttonStart,"Sans Serif",10,0,0,0,0);

  pvQPushButton(p,buttonRunDot,rightWidget);
  pvSetGeometry(p,buttonRunDot,10,250,100,30);
  pvSetText(p,buttonRunDot,pvtr("Run dot"));
  pvSetFont(p,buttonRunDot,"Sans Serif",10,0,0,0,0);

  pvQPushButton(p,pvHIDE,rightWidget);
  pvSetGeometry(p,pvHIDE,10,310,100,30);
  pvSetText(p,pvHIDE,pvtr("pvHIDE"));
  pvSetFont(p,pvHIDE,"Sans Serif",10,0,0,0,0);

  pvQPushButton(p,pvSHOW,rightWidget);
  pvSetGeometry(p,pvSHOW,10,340,100,30);
  pvSetText(p,pvSHOW,pvtr("pvSHOW"));
  pvSetFont(p,pvSHOW,"Sans Serif",10,0,0,0,0);
